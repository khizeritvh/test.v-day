...
const noMessages = [
    ...
    "I'd be devastated, just so you know… 😢",
    "I'm literally begging at this point 💔",
    "This is not how the story is supposed to go…",
    "Very last chance, I mean it 😭",
    "Fine, you can't catch me anyway 😜"
]
...
function handleNoClick() {
    ...
    const padY = Math.min(16 + noClickCount * 5, 58)
    const padX = Math.min(42 + noClickCount * 10, 120)
